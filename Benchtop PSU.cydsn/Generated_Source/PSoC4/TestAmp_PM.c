...
#if(!TestAmp_CHECK_DEEPSLEEP_SUPPORT)
    static TestAmp_BACKUP_STRUCT TestAmp_backup =
    {
        0u, /* enableState */
    };
#endif /* (TestAmp_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: TestAmp_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: TestAmp_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
*
* Global variables:
*  TestAmp_backup: The structure field 'enableState' is modified
...
{
#if(!TestAmp_CHECK_DEEPSLEEP_SUPPORT)
    if(TestAmp_CHECK_PWR_MODE_OFF)
    {
        TestAmp_backup.enableState = 1u;
        TestAmp_Stop();
    }
    else /* The component is disabled */
    {
        TestAmp_backup.enableState = 0u;
    }
#endif /* (TestAmp_CHECK_DEEPSLEEP_SUPPORT) */
}
...
*
* Global variables:
*  TestAmp_backup: The structure field 'enableState' is used to
...
{
#if(!TestAmp_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != TestAmp_backup.enableState)
    {
